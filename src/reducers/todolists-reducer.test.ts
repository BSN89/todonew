...
//
    ...
    const endState =
        todolistsReducer(startState, action)
//
...
test( 'correct filter of should change be changed', () => {
    //
    const todolistId1 = v1();
    const todolistId2 = v1();
    ...
    const action: ChangeTodoListFilterAT = ChangeTodoListFilterAC(newFilter, todolistId2)
